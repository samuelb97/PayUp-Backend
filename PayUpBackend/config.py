...
JWT_SECRET_KEY = "VWIlHp_HSsyvzZ4GcHt53bePi3-UNIRzHxitP40hK_w"
...
PROJECT_ID = 'payupelite'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'root'
CLOUDSQL_PASSWORD = 'WidgetGods369'
CLOUDSQL_DATABASE = 'payments'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'payupelite:us-central1:payments'
...
PLAID_SECRET = "1425f3e33058743591d64541ae9321"
